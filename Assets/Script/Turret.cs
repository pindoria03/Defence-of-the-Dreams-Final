//finds targets in the area of the tower and puts these enemies in an array.
//always shoots the closest target
//the turret head rotates and follows the nearest target
//shoot functions creates the bullet from the object. that created bullet then finds a target to travel towards
...
public class Turret : MonoBehaviour {
    ...
    void shoot() //shoot function
    {
        ...
        BulletN Bullet = BulletGameObject.GetComponent<BulletN>();
